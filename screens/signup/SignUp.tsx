...
const serviceTerms: TermsType[] = [
	...
	},
	{
		...
		body: 'By accessing or using the App, you agree to comply with and be bound by these Terms. If you do not agree to these Terms, please do not use the App.'
	},
	{
	...
	},
	{
		...
		body: '(a) In order to access certain features of the App, you may be required to create an account. You agree to provide accurate, current, and complete information during the registration process and to update such information to keep it accurate, current, and complete.\n' +
	...
	},
	{
		...
		body: '(a) By submitting, posting, or sharing any content on the App (such as reviews, comments, or photos), you grant Foodidy a non-exclusive, worldwide, royalty-free, perpetual, and irrevocable right to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, and display such content.\n' +
	...
	},
	{
		...
		body: '(a) The App and its content, including but not limited to text, graphics, logos, icons, images, audio clips, and software, are the property of Foodidy or its licensors and are protected by copyright, trademark, and other intellectual property laws.\n' +
	...
	{
		title: '6. Privacy',
		body: 'Your privacy is important to us. Please review our Privacy Policy  to understand how we collect, use, and disclose information.'
	},
	{
		title: '7. Disclaimers',
		body: 'The App is provided on an "as-is" and "as available" basis. We make no warranties or representations regarding the accuracy, reliability, or availability of the App.'
	},
	{
		title: '8. Limitation of Liability',
		body: 'To the extent permitted by applicable law, Foodidy shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or relating to your use of the App.'
	},
	{
		title: '9. Governing Law',
		body: 'These Terms shall be governed by and construed in accordance with the laws of Nibiru. Any disputes arising under or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts located in Nibiru.'
	},
	{
		title: '10. Changes to Terms',
		body: 'We reserve the right to modify or replace these Terms at any time. It is your responsibility to review these Terms periodically. By continuing to use the App after any changes to these Terms, you agree to be bound by such changes.'
	}
];
...
const policy: TermsType[] = [
	...
	},
	{
		...
		body: '(a) We use your information to provide and improve the App\'s services, process transactions, respond to your inquiries, and send you notifications.\n' +
	...
	{
		title: '3. How We Disclose Your Information',
		body: '(a) We may share your information with third-party service providers that assist us in providing and improving the App\'s services, such as payment processors and delivery partners.\n' +
	...
	},
	{
		...
		body: 'We implement reasonable security measures to protect your information from unauthorized access, loss, misuse, or disclosure. However, no method of transmission over the internet or electronic storage is completely secure.'
	},
	{
		title: '5. Your Choices',
		body: 'You can review and update your account information by accessing your profile settings in the App. You can also unsubscribe from marketing communications by following the instructions provided in the communication.'
	},
	{
		title: '6. Children\'s Privacy',
		body: 'The App is not intended for use by children under the age of 12. We do not knowingly collect personal information from children.'
	},
	{
		title: '7. Third-Party Links and Servicesg',
		body: 'The App may contain links to third-party websites or services that are not operated by us. We are not responsible for the privacy practices of such third parties.g'
	},
	{
		title: '8. Changes to this Privacy Policy',
		body: 'We reserve the right to modify this Policy at any time. Any changes will be effective when the revised Policy is posted. Your continued use of the App after such changes constitutes your acceptance of the revised Policy.'
	},
	{ title: '8. Changes to this Privacy Policy', body: 'Hmgngnng' },
	{
		title: '9. Contact Us',
		body: 'If you have any questions or concerns about this Privacy Policy, please contact us at foodidy@gmail.ru.'
	}
];
		...
		<GestureHandlerRootView style={[styles.container, { backgroundColor: isOpen ? 'grey' : 'white' }]}>
			...
			<Container justifyContent={'flex-start'}>
				...
				>
					...
					<TextInfo>By signing up, you agree to our<TouchableOpacity onPress={openTermsSheet}><LinkStyled> Terms of
						Service</LinkStyled>
					</TouchableOpacity> and acknowledge that our<TouchableOpacity onPress={openPrivacySheet}><LinkStyled> Privacy
						Policy </LinkStyled>
